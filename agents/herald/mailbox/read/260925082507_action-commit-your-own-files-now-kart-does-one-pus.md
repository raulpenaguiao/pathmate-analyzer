...
1. Run `git status` and pick out **only the files you changed**. Probably just your own agent folder. Check whether any of your artifact source files live in the repo.
2. Also commit your own `agents/herald/` folder: `AGENT.md`, `STATUS.md`, `context/` and `mailbox/`.
