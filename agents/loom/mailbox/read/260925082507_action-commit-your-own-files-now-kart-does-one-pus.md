...
1. Run `git status` and pick out **only the files you changed**. Likely yours: `tools/rgroups-table/rgroup_apply.py` and `tools/rgroups-table/rgroups_table.csv`.
2. Also commit your own `agents/loom/` folder: `AGENT.md`, `STATUS.md`, `context/` and `mailbox/`.
