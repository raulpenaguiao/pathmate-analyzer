...
1. Run `git status` and pick out **only the files you changed**. Likely yours: any remaining exporter/enrich changes under `tools/coaching-bundle-export/`, and probably `autochanges/2026-09-21-shared-read-table-dense-primitive.md`. Confirm that one is yours.
2. Also commit your own `agents/warden/` folder: `AGENT.md`, `STATUS.md`, `context/` and `mailbox/`.
