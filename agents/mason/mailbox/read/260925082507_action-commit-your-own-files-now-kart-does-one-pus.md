...
1. Run `git status` and pick out **only the files you changed**. Likely yours: `docs/ALEX_v02_redesign_spec.md` and the new `docs/pileup/` folder. Leave `docs/coaching_categories_table.md` alone; Raul still has to confirm deleting it.
2. Also commit your own `agents/mason/` folder: `AGENT.md`, `STATUS.md`, `context/` and `mailbox/`.
