...
1. Run `git status` and pick out **only the files you changed**. Your engine work looks committed already. Check whether anything is left (plan doc, tests).
2. Also commit your own `agents/mirror/` folder: `AGENT.md`, `STATUS.md`, `context/` and `mailbox/`.
